...
export default function PollRoom() {
    ...
    if (notFound) {
        return (
            <div className="page-container">
                <div className="glass-card text-center animate-fade-in-up" style={{ maxWidth: '440px', padding: '48px 36px' }}>
                    ...
                    <p className="text-sm mb-7" style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
    ...
    if (loading) {
        return (
            <div className="page-container">
                <div className="glass-card animate-fade-in-up" style={{ maxWidth: '580px', width: '100%', padding: '40px' }}>
                    <div className="skeleton mb-3" style={{ height: '24px', width: '60%' }} />
                    <div className="skeleton mb-8" style={{ height: '14px', width: '30%' }} />
    ...
    return (
        <div className="page-container">
            <div className="w-full" style={{ maxWidth: '580px' }}>
                ...
                <div className="flex items-center justify-between mb-5 animate-fade-in-up">
                    ...
                    >
                        ...
                        <span
                            ...
                            style={{ color: isConnected ? 'var(--success)' : 'var(--warning)' }}
                        >
                ...
                {/* Poll Card */}
                <div className="glass-card animate-fade-in-up animate-delay-1" style={{ padding: '36px' }}>
                    {/* Question */}
                    <h1
                    ...
                    {/* Total votes */}
                    <p className="mb-6" style={{ color: 'var(--text-muted)', fontSize: '13px' }}>
                    ...
                    {hasVoted && (
                        ...
                        >
                            ...
                            <span className="text-sm" style={{ color: 'var(--success)' }}>
                                You voted for{' '}
                                <strong>
                                    {poll.options.find((o) => o._id === votedOptionId)?.text || 'an option'}
                                </strong>
                            </span>
                        </div>
                    )}
